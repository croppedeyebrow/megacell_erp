...
- `ERP_Front/` — React 프론트엔드
- `ERP_Backend/` — FastAPI 백엔드 (`app/`, `requirements.txt`)
- `ERP_Backend/legacy/streamlit/` — 전환용 Streamlit (조회 전용)
- `ERP_Infra/`
- `docs/` — 기획·설계·운영 문서
- 루트 `README.md`
...
`deploy.bat`은 `ERP_Infra/scripts/deploy.bat`을 호출합니다.
